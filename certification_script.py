...
2. Путь к xlxs файлу в котором содержатся целевые значения для проведения сертификации (Компетенции_по_шкале_DE.xlsx)
...
if __name__ == '__main__':
    ...
    for path in marks_file:
        certificate(path, 'Оценка компетенций', target_values_file, 'Целевые значения', save_to)
